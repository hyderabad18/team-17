...
<div class="main" align="center">
    ...
    <p style="color: #32cd32">You're one step away!!</p><br>
    <form name="customerreg" class="form1" align="center" action="vreg.php" method="POST">
      ...
      <input class="mail" type="text" placeholder="subject" name="subject" required>    
      <input class="submit" type="submit" value="Sign up" align="center" required> 
    </form>
  </div>
</body>
</html>